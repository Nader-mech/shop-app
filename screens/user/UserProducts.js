...
const UserProductsScreen = props => {
    ...
    if(userProducts.length === 0){
        ...
        <Text>No products here yet .Maybe you should start to add some</Text>
        </View>
    }
    // console.log(userProducts)
    return <FlatList data={userProducts} keyExtractor={item => item.id} renderItem={itemData => <ProductItem
        ...
        <Button color={Colors.primaryColor} title='Delete' onPress={deleteHandler.bind(this, itemData.item.id)} />
    </ProductItem>} />
}
